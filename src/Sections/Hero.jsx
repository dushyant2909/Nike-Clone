  ...
  return (
    <section id='home' className="w-full flex xl:flex-row flex-col justify-center gap-10 p-2 max-container min-h-screen">
      ...
      <div className='flex-1 relative flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoe1} alt="Shoe Collection" className='object-contain relative z-10' width={610} height={500} />
        <div className="">
          {shoes.map((shoe) => (
            <div key={shoe}><ShoeCard imgUrl={shoe} changeBigShoeImage={() => { }} bigShoeImage="" /></div>
          ))}
        </div>
      </div>
    </section>
